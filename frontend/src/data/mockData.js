export const AVAILABLE_MODELS = [
  { id: 'llama-3.3-70b', name: 'Llama 3.3 70B (Local Quant)', tag: 'Fast' },
  { id: 'deepseek-r1', name: 'DeepSeek R1 Distill', tag: 'Reasoning' },
  { id: 'qwen-2.5-coder', name: 'Qwen 2.5 Coder 32B', tag: 'Coding' },
];
